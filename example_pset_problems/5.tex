...
\begin{enumerate}[(a)]
  \item %(a)
  With $p=1$, $q=0$, $\s=1$, the Rayleigh quotient for \eqref{pdeEx5} becomes
  ...
  \item %(b)
  Orthogonality results directly from noticing that \eqref{pdeEx5} subject to the boundary conditions in \eqref{bc}
  ...
  Let $\l_m$ and $\l_n$ be eigenvalues of \eqref{pdeEx5} with corresponding eigenfunctions $\h_m$ and $\h_n$. Then we have
  \begin{align}
  ...
  \begin{figure}[ht!]
    \centering
    \input{example_pset_problems/plot.tex}
